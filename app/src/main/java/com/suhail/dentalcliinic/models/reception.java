...
public class reception {
    ...
    public reception(String name, String email, String phone, String address, String gender, int identityNumber, String membershipNumber, String specialization, String imageUrl, ArrayList<String> workDays, ArrayList<String> workHours, Date hiringDate, Date endDate) {
        this.name = name;
        this.email = email;
        this.phone = phone;
